...
ym.modules.define('shri2017.imageViewer.EventManager', [
    ...
    extend(EventManager.prototype, {
        ...
        _setupListeners: function () {
            ...
            this._elem.addEventListener('gesturestart', function(event) {
...
provideCss("body,html{margin:0;padding:0}#holder{margin:20px auto;width:700px;touch-action:none}.image-viewer__view{display:block;background-color:#d7dcdd;touch-action:none}", provide);
});
